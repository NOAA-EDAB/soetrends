...
## Human Dimension indicators {.tabset}

### Commercial
```{r, warning=FALSE, message=FALSE, echo=FALSE}
get_summary("Landings_Managed", "MAB")
get_summary("Revenue_Managed", "MAB")
...
get_summary("Recreational_Catch_Diversity", "MAB")
```

## Low Trophic indicators
```{r, warning=FALSE, message=FALSE, echo=FALSE}
get_summary("Bottom_Temp", "MAB")
get_summary("Heatwave_Cumulative_Intensity", "MAB")
get_summary("Heatwave_Maximum_Intensity", "MAB")
